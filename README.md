...
Run `sbt package` and copy generated `/target/scala-2.12/gitbucket-maven-repository-plugin_2.12-x.x.x.jar` to `~/.gitbucket/plugins/` (If the directory does not exist, create it by hand before copying the jar), or just run `sbt install`.
